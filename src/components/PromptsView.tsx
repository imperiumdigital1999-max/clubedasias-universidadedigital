    ...
    },
{
  ...
  },
  {
    ...
    "titulo": "VENDEDORA PRODUTOS NATURAIS - ZERO GLUTEN",
    "prompt_texto": "{ \"scene\": \"4K cinematic shot in a natural products aisle dedicated to gluten-free items. Shelves display breads, pasta alternatives and snacks with bright, clean packaging. The atmosphere is calm and friendly.\", \"characters\": [ { \"name\": \"Store Advisor\", \"description\": \"Brazilian woman in her mid-30s, well-presented, wearing a store apron with natural tones.\", \"actions\": [ \"Holds two gluten-free products and compares them side-by-side.\", \"Points to the ingredients list and gluten-free certification.\", \"Smiles with confidence while explaining the difference.\", \"Makes a welcoming gesture inviting viewers to explore.\" ], \"speech\": \"Muita gente acha que produto zero glúten não tem sabor, até provar um desses aqui.\", \"voice\": \"Brazilian Portuguese voice, warm, convincing and friendly.\" } ], \"environment\": { \"location\": \"Gluten-free aisle of a natural store.\", \"details\": \"Color-coded shelves, wheat-free labels, rustic baskets, soft daylight entering from store windows.\" }, \"camera\": { \"angle\": \"Medium shot capturing seller, shelves and products in her hands.\", \"movement\": \"Slow lateral movement to reveal more products while she talks.\", \"focus\": \"On items being shown, with her face remaining slightly softened.\" }, \"audio\": { \"dialogue\": \"Muita gente acha que produto zero glúten não tem sabor, até provar um desses aqui.\", \"ambient\": \"Light store ambience, quiet footsteps, soft organic background music.\" }, \"technical\": { \"resolution\": \"4K\", \"model\": \"Veo 3\", \"style\": \"Cinematic gluten-free product explanation\", \"frame_rate\": \"24fps\", \"duration\": \"10–11 seconds\" }, \"negative_prompts\": [ \"no cluttered aisles\", \"no faded packaging\", \"no fluorescent lighting flicker\", \"no subtitles\" ], \"mood\": \"Trustworthy, educational, warm.\" }",
    ...
    "gif_url": "https://zxhpvxjtxtjydexjnfjj.supabase.co/storage/v1/object/public/media/veo3-gifs/1764368821264-_scene_4k_202511281926_yo6or.gif",
  ...
  },
  {
    ...
    "titulo": "HIGIENIZAÇÃO CORTINA",
    "prompt_texto": "{ \"scene\": \"4K cinematic cleaning scene in a cozy living room with long blackout curtains. The focus is on practical, efficient in-place curtain cleaning without removing the fabric from the rod.\", \"characters\": [ { \"name\": \"Curtain Cleaning Technician\", \"description\": \"Brazilian female technician, wearing a clean uniform and protective gloves, precise and efficient.\", \"actions\": [ \"Uses a vertical steam cleaner along the length of the curtain.\", \"Applies a neutral cleaning solution with a sprayer and wipes gently with a microfiber cloth.\", \"Shows the difference between a cleaned section and an untouched dusty area.\", \"Smiles slightly toward the camera while explaining the benefit.\" ], \"speech\": \"Essa técnica limpa a fundo sem precisar montar tudo. Ótima pra quem quer praticidade e resultado rápido.\", \"voice\": \"Brazilian Portuguese voice, practical, confident and friendly.\" } ], \"environment\": { \"location\": \"Living room with long curtains.\", \"details\": \"Floor-to-ceiling curtains, sofa, coffee table, rug, TV stand, natural light partially blocked by the curtains.\" }, \"camera\": { \"angle\": \"Vertical framing showing full curtain height, then closer detail of the cleaned vs. dirty area.\", \"movement\": \"Slow upward movement following the steam cleaner, then a slight zoom on the fabric contrast.\", \"focus\": \"On the curtain fabric texture and visible cleanliness improvement.\" }, \"audio\": { \"dialogue\": \"Essa técnica limpa a fundo sem precisar montar tudo. Ótima pra quem quer praticidade e resultado rápido.\", \"ambient\": \"Soft steam sound, light room tone, faint traffic noise outside the window.\" }, \"technical\": { \"resolution\": \"4K\", \"model\": \"Veo 3\", \"style\": \"Cinematic home-service demonstration\", \"frame_rate\": \"24fps\", \"duration\": \"10–12 seconds\" }, \"negative_prompts\": [ \"no extremely dirty curtain close-ups\", \"no harsh backlight washing out details\", \"no messy living room\", \"no subtitles\", \"no surreal lights\" ], \"mood\": \"Practical, efficient, clean, satisfying.\" }",
  ...
  },
  {
    ...
    "titulo": "LAVAGEM DE ESTOFADOS",
    "prompt_texto": "{ \"scene\": \"4K cinematic service scene in a clean indoor area where a baby stroller is fully disassembled and deep cleaned. The focus is on safety, hygiene and care for babies.\", \"characters\": [ { \"name\": \"Baby Gear Cleaning Specialist\", \"description\": \"Brazilian female technician, wearing a clean uniform and disposable gloves, careful and meticulous.\", \"actions\": [ \"Removes the fabric parts from the stroller frame and places them on a workbench.\", \"Uses a hot steam cleaner on straps, seat and folds.\", \"Applies upholstery-safe detergent and then uses an extraction machine on the fabric.\", \"Shows the color difference between a cleaned area and an uncleaned one while speaking.\" ], \"speech\": \"Carrinho de bebê precisa de higienização regular. A gente remove ácaros, suor e poeira, deixando tudo seguro pra criança.\", \"voice\": \"Brazilian Portuguese voice, caring, calm and trustworthy.\" } ], \"environment\": { \"location\": \"Dedicated indoor cleaning area.\", \"details\": \"Workbench, hooks for parts, labeled shelves for baby accessories, soft neutral colors, bright lighting.\" }, \"camera\": { \"angle\": \"Medium close-up of the stroller seat fabric being cleaned, then wider shot including the full workbench.\", \"movement\": \"Smooth handheld movement for realistic service feel.\", \"focus\": \"On the stroller fabric, stitching and straps being sanitized.\" }, \"audio\": { \"dialogue\": \"Carrinho de bebê precisa de higienização regular. A gente remove ácaros, suor e poeira, deixando tudo seguro pra criança.\", \"ambient\": \"Steam cleaner sound, light extraction noise, soft room tone.\" }, \"technical\": { \"resolution\": \"4K\", \"model\": \"Veo 3\", \"style\": \"Cinematic baby-safety cleaning promo\", \"frame_rate\": \"24fps\", \"duration\": \"10–12 seconds\" }, \"negative_prompts\": [ \"no disturbing dirt close-ups\", \"no stained walls\", \"no harsh shadows\", \"no subtitles\", \"no surreal props\" ], \"mood\": \"Protective, careful, family-focused, trustworthy.\" }",
    ...
    "gif_url": "https://zxhpvxjtxtjydexjnfjj.supabase.co/storage/v1/object/public/media/veo3-gifs/1764367696487-_scene_4k_202511281907_xyjxo.gif",
  ...
  },
  {
    ...
    "titulo": "HIGIENIZAÇÃO ESTOFADOS",
    "prompt_texto": "{ \"scene\": \"4K cinematic scene in a small home office where a fabric office chair with visible wear marks is being deep cleaned. The environment feels practical, organized and relatable to everyday users.\", \"characters\": [ { \"name\": \"Cleaning Professional\", \"description\": \"Brazilian adult, wearing a branded polo and work pants, calm and efficient.\", \"actions\": [ \"Shows a clear 'before' of the stained seat of the office chair.\", \"Sprays cleaning solution and uses a steam or vapor machine on the fabric.\", \"Runs an extraction machine evenly over the seat and backrest.\", \"Positions the chair for a side-by-side 'before and after' shot while speaking to camera.\" ], \"speech\": \"Essas cadeiras acumulam suor, poeira e bactéria sem você perceber. Uma higienização dessas renova até o ambiente inteiro.\", \"voice\": \"Brazilian Portuguese voice, informative, confident and reassuring.\" } ], \"environment\": { \"location\": \"Small Brazilian home office.\", \"details\": \"Desk with modern notebook, small plant, shelves with books, office chair on wheels, neutral wall tones.\" }, \"camera\": { \"angle\": \"Medium shot of the technician working on the chair, then static frame showing side-by-side result.\", \"movement\": \"Slow handheld micro-movements for realism, slight repositioning for the before-and-after reveal.\", \"focus\": \"Emphasis on the chair surface and fabric transformation.\" }, \"audio\": { \"dialogue\": \"Essas cadeiras acumulam suor, poeira e bactéria sem você perceber. Uma higienização dessas renova até o ambiente inteiro.\", \"ambient\": \"Soft machine noise, light room tone, faint keyboard or office ambience in background.\" }, \"technical\": { \"resolution\": \"4K\", \"model\": \"Veo 3\", \"style\": \"Cinematic home-service cleaning scene\", \"frame_rate\": \"24fps\", \"duration\": \"10–12 seconds\" }, \"negative_prompts\": [ \"no extremely disgusting close-ups\", \"no cluttered office\", \"no fluorescent flicker\", \"no subtitles\", \"no surreal effects\" ], \"mood\": \"Professional, clean, educational, satisfying.\" }",
    ...
    "gif_url": "https://zxhpvxjtxtjydexjnfjj.supabase.co/storage/v1/object/public/media/veo3-gifs/1764367640484-_scene_4k_202511281906_4bkl6.gif",
  ...
  },
  {
    ...
    "titulo": "CURSO INFORMÁTICA - DESIGN",
    "prompt_texto": "{ \"scene\": \"4K cinematic scene inside a modern digital design classroom equipped with sleek MacBooks, large monitors, and warm LED lighting. The environment has a creative and premium atmosphere, with moodboards, printed artworks, and color palettes displayed on the walls.\", \"characters\": [ { \"name\": \"Design Student\", \"description\": \"Brazilian young woman in her early 20s, creative and focused, wearing casual stylish clothing.\", \"actions\": [ \"Uses a MacBook with Photoshop open while fine-tuning a flyer layout.\", \"Zooms in on details and adjusts color gradients using the trackpad.\", \"Smiles proudly as she sees her design coming together on the screen.\", \"Looks at the camera with excitement ABOUT her progress.\" ], \"speech\": \"É incrível ver o brilho nos olhos quando alguém descobre que consegue criar arte profissional mesmo sendo iniciante.\", \"voice\": \"Brazilian Portuguese voice, inspiring, warm and full of enthusiasm.\" } ], \"environment\": { \"location\": \"Modern digital design classroom.\", \"details\": \"MacBooks open with Adobe Creative Cloud apps, color swatch books on desks, LED strip lighting, posters of famous designs on walls, students working independently with headphones.\" }, \"camera\": { \"angle\": \"Close-up shot on the MacBook screen showing the flyer design, then medium shot revealing the student working confidently.\", \"movement\": \"Smooth lateral dolly to highlight the creative environment and modern equipment.\", \"focus\": \"Crisp focus on the screen and the student's actions, with the classroom softly blurred in the background.\" }, \"audio\": { \"dialogue\": \"É incrível ver o brilho nos olhos quando alguém descobre que consegue criar arte profissional mesmo sendo iniciante.\", \"ambient\": \"Soft clicking of trackpads, faint design class ambience, subtle background music from another student's headphones.\" }, \"technical\": { \"resolution\": \"4K\", \"model\": \"Veo 3\", \"style\": \"Cinematic creative-education promotional scene\", \"frame_rate\": \"24fps\", \"duration\": \"10–12 seconds\" }, \"negative_prompts\": [ \"no outdated computers\", \"no cluttered desks\", \"no harsh neon lighting\", \"no unfinished classroom decor\", \"no subtitles\" ], \"mood\": \"Creative, inspiring, empowering, visually premium.\" }",
    ...
    "gif_url": "https://zxhpvxjtxtjydexjnfjj.supabase.co/storage/v1/object/public/media/veo3-gifs/1764366166861-_scene_4k_202511281842_xtjxx.gif",
  ...
  },
  {
    ...
    "titulo": "CURSO INFORMÁTICA EXCEL",
    "prompt_texto": "{ \"scene\": \"4K cinematic scene inside a modern professional training classroom equipped with sleek MacBooks and premium notebooks. A large projector screen displays Excel dashboards, formulas, and real-world data examples. The environment is clean, updated, and visually professional.\", \"characters\": [ { \"name\": \"Excel Instructor\", \"description\": \"Brazilian man in his early 40s, confident and experienced, wearing business-casual clothing.\", \"actions\": [ \"Points to formulas and conditional formatting on the projected screen.\", \"Walks between students, checking their screens and offering guidance.\", \"Touches the trackpad of a student's MacBook to demonstrate a function.\", \"Faces the camera briefly with a reassuring expression.\" ], \"speech\": \"Quando a pessoa aprende Excel de verdade, ela destrava oportunidades que estavam travadas pela falta de conhecimento técnico.\", \"voice\": \"Brazilian Portuguese voice, professional, calm and motivating.\" } ], \"environment\": { \"location\": \"Modern Excel and data-analysis training classroom.\", \"details\": \"Rows of MacBooks and slim notebooks, projector showing spreadsheets, ergonomic chairs, LED soft lighting, clean desks, students focused on learning.\" }, \"camera\": { \"angle\": \"Medium shot showing the instructor near the projector while students work on MacBooks.\", \"movement\": \"Smooth dolly-in toward the instructor as he explains key concepts.\", \"focus\": \"Sharp focus on instructor and MacBook screens with real Excel formulas visible.\" }, \"audio\": { \"dialogue\": \"Quando a pessoa aprende Excel de verdade, ela destrava oportunidades que estavam travadas pela falta de conhecimento técnico.\", \"ambient\": \"Soft keyboard tapping, faint classroom discussions, quiet projector fan noise.\" }, \"technical\": { \"resolution\": \"4K\", \"model\": \"Veo 3\", \"style\": \"Cinematic professional-training promotional scene\", \"frame_rate\": \"24fps\", \"duration\": \"10–12 seconds\" }, \"negative_prompts\": [ \"no outdated computers\", \"no CRT monitors\", \"no messy desks\", \"no neon oversaturation\", \"no subtitles\" ], \"mood\": \"Professional, empowering, focused, educational.\" }",
