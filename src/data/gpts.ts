...
export const gptTags = [
  "GPT's Criação de Imagem",
  "GPT's de Criação de Conteúdo",
  "GPT's de Revenda",
  "GPT's VEO 3",
  "GPT's de Ensino"
];

export const allGPTs: GPT[] = [
  {
    id: '1',
    ...
    image: 'https://zxhpvxjtxtjydexjnfjj.supabase.co/storage/v1/object/public/media/89979645-37b3-4681-971e-c0b77a3bf2a9/1755345010480-IMG_6685.jpeg',
    rating: 4.5
  },
  {
    id: '2',
